...
";
    ...
    {
        return new Source("", "login/footer.twig", "/workspaces/the-veep-factory/back-end/wordpress/htdocs/.local/phpMyAdmin-5.2.2-all-languages/templates/login/footer.twig");
    }
}
