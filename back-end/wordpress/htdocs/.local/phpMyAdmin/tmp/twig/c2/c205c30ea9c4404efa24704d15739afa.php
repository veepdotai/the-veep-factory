...
";
    ...
    {
        return new Source("", "login/header.twig", "/workspaces/the-veep-factory/back-end/wordpress/htdocs/.local/phpMyAdmin-5.2.2-all-languages/templates/login/header.twig");
    }
}
