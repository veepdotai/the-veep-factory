...
class FacetRegistry {
	...
	private static function register_facet_connection( array $facet_config ): void {
		...
		$myargs = PostObjects::get_connection_args();
		/*
		$myargs["metaQuery"] = [
			'type'        => 'VcontentFacets...VcontentsMetaQuery', # This type has not been created!!!
			'description' => 'Marketing',
		];
		error_log("Connection: " . print_r( $myargs, true ), 3, "/tmp/wp-graphql-facetwp.log" )
		*/
		...
		$default_facet_connection_config = [
			...
			'connectionArgs' => $myargs,
			//RootQueryToVcontentConnectionWhereArgsMetaQuery
