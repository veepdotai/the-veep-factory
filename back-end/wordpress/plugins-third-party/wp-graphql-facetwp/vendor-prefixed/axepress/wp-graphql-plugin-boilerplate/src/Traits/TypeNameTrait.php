...
namespace WPGraphQL\FacetWP\Vendor\AxeWP\GraphQL\Traits;

use WPGraphQL\FacetWP\Vendor\AxeWP\GraphQL\Helper\Helper;
use Exception;
if (!trait_exists('\WPGraphQL\FacetWP\Vendor\AxeWP\GraphQL\Traits\TypeNameTrait')) {
    /**
     * Trait - TypeNameTrait
     */
    trait TypeNameTrait
    {
        ...
        final public static function get_type_name(): string
        {
             ...
             */
            return apply_filters($hook_prefix . '_type_prefix', '', $type_name) . $type_name;
