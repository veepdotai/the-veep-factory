...
// wp-graphql/src/Router.php for GRAPHQL only.
// For REST calls, another CORS configuration must be set
...
class Router {
	 ...
	 */
	protected static function get_response_headers_orig() {
...
//				'Content-Language',
		...
		$headers = [
			...
			'Access-Control-Allow-Origin'  => 'https://humble-space-capybara-v494vgwqp6xcwpv4-3000.app.github.dev',
			'Access-Control-Allow-Credentials' => 'true',
			'Access-Control-Allow-Headers' => implode( ', ', $access_control_allow_headers ),
			'Access-Control-Max-Age'       => 600,
			// cache the result of preflight requests (600 is the upper limit for Chromium).
