...
class Veepdotai_AppPrefs_REST_Controller extends WP_REST_Controller {

    // Here initialize our namespace and resource name.
    public function __construct() {
        $this->namespace     = 'veepdotai_rest/v1';
        $this->resource_name = 'app_prefs';
    }
    ...
    public function post_item( $request ) {
        ...
        $user_prefs = sanitize_text_field( $request['app-prefs'] );
        ...
        $user_default_attr = [ ...$user_back_attrs, ...$user_front_attrs ];
...
function veepdotai_rest_app_prefs_register_my_routes() {
    $controller = new Veepdotai_AppPrefs_REST_Controller();
    $controller->register_routes();
}

add_action( 'rest_api_init', 'veepdotai_rest_app_prefs_register_my_routes' );
