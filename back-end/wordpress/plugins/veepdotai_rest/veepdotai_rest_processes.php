...
class Veepdotai_Processes_REST_Controller extends WP_REST_Controller {
    ...
    public function execute( $request ) {
        Veepdotai_Util::log( 'debug', "input: " . $request['input']);
...
function veepdotai_rest_processes_register_my_routes() {
    $controller = new Veepdotai_Processes_REST_Controller();
    $controller->register_routes();
}

add_action( 'rest_api_init', 'veepdotai_rest_processes_register_my_routes' );
