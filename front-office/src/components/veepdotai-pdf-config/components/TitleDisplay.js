        ...
        return (
            <div className='items-center h-full justify-center list-item'>
              <div>
                ...
                <input id="PDFDocumentTitle" type='text'
                  defaultValue={this.props.defaultTitle} placeholder={t("PDFDocumentTitle")}
              ...
              <div className='mt-2'>
                ...
                <input id="PDFDocumentSubtitle" type='text'
                  defaultValue={this.props.defaultSubtitle} placeholder={t("PDFDocumentSubtitle")}
              ...
              <div className='mt-2'>
                ...
                <input id="OrgName" type="text"
                  defaultValue={this.props.defaultName} placeholder={t("OrgName")}
                  className='p-1 w-full border-grey border-solid border-1 rounded'
              ...
              <div className='mt-2'>
                ...
                <input id="AuthorName" type='text'
                  defaultValue={this.props.defaultAuthor} placeholder={t("AuthorName")}
                  className='p-1 w-full border-grey border-solid border-1 rounded'
